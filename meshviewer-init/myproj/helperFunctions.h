...
void makeBuffers(myMesh *input_mesh)
{
	...
	{
		myHalfedge *e = input_mesh->faces[i]->halfEdgeAdj->next;
		do {
			verts.push_back((GLfloat)input_mesh->faces[i]->halfEdgeAdj->source->point->X);
			verts.push_back((GLfloat)input_mesh->faces[i]->halfEdgeAdj->source->point->Y);
			verts.push_back((GLfloat)input_mesh->faces[i]->halfEdgeAdj->source->point->Z);
			input_mesh->faces[i]->halfEdgeAdj->source->index = index;
			index++;
			...
			norms.push_back((GLfloat)input_mesh->faces[i]->halfEdgeAdj->source->normal->dX);
			norms.push_back((GLfloat)input_mesh->faces[i]->halfEdgeAdj->source->normal->dY);
			norms.push_back((GLfloat)input_mesh->faces[i]->halfEdgeAdj->source->normal->dZ);
			...
			num_triangles++;
			e = e->next;
		} while (e->next != input_mesh->faces[i]->halfEdgeAdj);
	}
